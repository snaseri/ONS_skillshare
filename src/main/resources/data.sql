...
insert into Skills (id, name, description) values (1, 'Georgian', 'Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.');
insert into Skills (id, name, description) values (2, 'Hindi', 'Etiam pretium iaculis justo.');
insert into Skills (id, name, description) values (3, 'Telugu', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.');
insert into Skills (id, name, description) values (4, 'Gujarati', 'Morbi vel lectus in quam fringilla rhoncus.');
insert into Skills (id, name, description) values (5, 'Lithuanian', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla.');
